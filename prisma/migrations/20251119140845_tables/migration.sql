...
CREATE TYPE "ThreatCategory" AS ENUM ('malware', 'pua', 'spyware', 'adware');
CREATE TYPE "CommandType" AS ENUM ('locate', 'lock', 'wipe', 'alarm');
...
CREATE TABLE "ThreatSignature" (
    "id" TEXT NOT NULL,
    "type" TEXT NOT NULL, -- Keep if 'type' varies; otherwise convert to ENUM
...
CREATE TABLE "Quarantine" (
    ...
    "threatName" TEXT NOT NULL,
    "severity" Severity NOT NULL,
    "status" QuarantineStatus NOT NULL,
    "storageKey" TEXT,
    "storageUrl" TEXT,
...
CREATE TABLE "AntiTheftCommand" (
    ...
    "status" AntiTheftCommandStatus NOT NULL,
